...
namespace WpfCommands
{
    internal class MainWindowViewModel : INotifyPropertyChanged
    {
        ...
        public MainWindowViewModel()
        {
            ...
            User2.Name = "Test";
            User2.Age = 10;
            User2.PropertyChanged += User2_PropertyChanged;
            User2.PropertyChanging += User2_PropertyChanging;
        ...
        private void User2_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            String pn = e.PropertyName;
        }

        private void User2_PropertyChanging(object sender, PropertyChangingEventArgs e)
        {
            String pn = e.PropertyName;
        }
